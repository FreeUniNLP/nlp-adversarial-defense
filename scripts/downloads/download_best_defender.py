...
Usage:
    ...
    python scripts/downloads/download_best_defender.py --run-id 5dfceb980dff40cea7011baaab6ecfa9
    python scripts/downloads/download_best_defender.py --experiment MiniGPT
