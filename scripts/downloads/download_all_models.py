...
Usage:
    ...
    python scripts/downloads/download_all_models.py --experiment MiniGPT
    python scripts/downloads/download_all_models.py --best-only
    python scripts/downloads/download_all_models.py --experiment AttackerREINFORCE --best-only
    python scripts/downloads/download_all_models.py --finished-only
"""
