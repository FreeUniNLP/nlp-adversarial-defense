...
Usage:
    python scripts/downloads/download_best_attacker.py
    python scripts/downloads/download_best_attacker.py --experiment AttackerREINFORCE
    python scripts/downloads/download_best_attacker.py --run-id 32b6b9dbc1174127ab2787e6289d6a96
    python scripts/downloads/download_best_attacker.py --artifact attacker_final.pt
...
def main() -> None:
    ...
    print(f"  python scripts/eval/attack_and_complete.py --attacker-ckpt \"{local_path}\" --n 100")
